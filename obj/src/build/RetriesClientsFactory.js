...
const RetiresDirectClientV1_1 = require("../version1/RetiresDirectClientV1");
...
class RetriesClientsFactory extends pip_services3_components_node_1.Factory {
    constructor() {
        super();
        this.registerAsType(RetriesClientsFactory.DirectClientDescriptor, RetiresDirectClientV1_1.RetriesDirectClientV1);
